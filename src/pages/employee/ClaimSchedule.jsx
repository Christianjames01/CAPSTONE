        ...
        try {
            ...
            if (existingSchedule) {
                ...
                await logActivity({
                    ...
                    description: `Created claiming schedule for request "${request?.request_number || requestId}" on ${formatDate(scheduledDate)} at ${formatTime(scheduledTime)}.`,
                })
        ...
        return (
            <SkeletonPage
                ...
                blocks={[
                    ...
                    { type: 'card', fields: 4, titleWidth: 190 },
                    { type: 'card', lines: 2, buttons: 2, titleWidth: 190 },
                    { type: 'card', rows: 3, titleWidth: 170 },
                ]}
            />
        )
    }
