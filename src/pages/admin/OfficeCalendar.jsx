                    ...
                    {dayModalEvents.length === 0 ? (
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', gap: 8, marginBottom: 16 }}>
                            {dayModalEvents.map((ev) => (
                                <div key={ev.event_id} className="admin-list-card" style={{ marginBottom: 0, padding: 12 }}>
            ...
            {showRangeModal && (
                ...
                >
                    ...
                    <div style={{ display: 'flex', gap: 10, alignItems: 'center' }}>
                        ...
                        <button className="admin-secondary-button" style={{ color: 'var(--red)', borderColor: 'var(--red)' }} onClick={() => setShowRangeModal(false)} disabled={addingRange}>
                            Cancel
                        </button>
                    </div>
                </Modal>
